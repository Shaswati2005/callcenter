...
export default function Page() {
  ...
  return (
    <div className="px-8 py-12 sm:py-16 md:px-20">
      <div className="mx-auto w-fit overflow-hidden rounded-lg bg-purple-900 shadow-lg">
        <div className="p-8">
          ...
          <h3 className="text-xl font-semibold text-white w-full text-center py-2">
            Welcome to EliteSupport!
          </h3>
          <p className="mt-2 text-sm text-white w-full text-center ">
